  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        {/* Campus image background - full coverage */}
        <img 
          src={campusImage} 
        ...
        {/* Content overlay - positioned directly on image */}
        <div className="relative z-10 flex flex-col justify-center items-center px-12 text-white w-full h-full">
          ...
          {/* Title */}
          <h1 className="text-5xl font-bold mb-3 text-center leading-tight drop-shadow-lg text-rainbow-animated">
            MSEC PMS
          </h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-8" style={{ backgroundColor: '#FFFFF0' }}>
        <div className="w-full max-w-md">
          <div className="lg:hidden flex flex-col items-center justify-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-rainbow-animated">MSEC PMS</h2>
          </div>
