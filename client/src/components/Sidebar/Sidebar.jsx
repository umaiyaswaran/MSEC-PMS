...
const Sidebar = ({ role, isOpen, onClose }) => {
  ...
  const menuItems = {
    ...
    store_manager: [
      ...
      {
        label: 'Open POs',
        path: '/store-manager/open-purchase-orders',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {
        label: 'Profile',
        path: '/store-manager/settings/profile',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
          </svg>
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-16 left-0 bottom-0 w-64 border-r border-gray-200 z-40 transform transition-transform duration-300 ease-in-out ${
